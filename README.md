...
Актуальный контракт — PRODUCT_SPEC 1.1 и SPEC 1.2, порядок работ — PLAN 1.1. Основа Astra дополнена планом дневных признаков, обзора SCC/межкластерных потоков и запросов недостающих данных. P1 следует после работающего ядра; определения и приёмка зафиксированы в SPEC §10. Карточки Trello синхронизированы; ссылки и журнал изменений — PLAN §8–10.
