...
Текущий общий контракт — PRODUCT_SPEC 1.3 / SPEC 1.4 / PLAN 1.3. Реализованная HA-17 добавила объяснения в `hackalem/scoring.py`/report, а React показывает причины, общую шкалу рёбер, вторичные роли и равные P. HA-16 и HA-14 остаются P1-заделом: для них согласованы датированные counts/свидетели и `hackalem/requests.py`, но они не входят в текущий React-выпуск. Основные роли/P/CSV-схемы сохранены. Очередь P1: HA-11 → HA-14 → HA-16 → HA-13; общий viewer и одно состояние selectedGid.
