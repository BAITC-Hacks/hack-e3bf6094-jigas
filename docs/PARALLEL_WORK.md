...
2. Выберите **одну** доступную, не занятую другим чатом карточку с отдельным результатом и файлами. До кода запишите в её описание: контур/чат, ветку, base SHA, файлы, критерий проверки и следующего получателя. Переместите её в «В работе». Участника Trello не назначайте.
