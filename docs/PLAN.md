...
Архивы организатора лежат локально в `track_data/starter (1).zip` и `track_data/data (1).zip`, в Git их нет. В другом окружении получить тот же вход установленным организатором способом через капитана; отсутствие данных не заменять придуманным «официальным» набором. UI-пример и граничные тесты используют явно искусственные данные.
